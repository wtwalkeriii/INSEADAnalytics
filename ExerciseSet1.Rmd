...
<br>
<br>
https://github.com/djg07/DividendTracker
<hr>
<hr>
...
**Your Answers here:**
<br>1. AAPL is identified in line 8 of dataset1.R
<br>2. `r round(100*sum(StockReturns[,2]),1)`%, `r round(100*mean(StockReturns[,2]),3)`%, `r round(100*sd(StockReturns[,2]),3)`%
<br>
<br>
...
**Your Answers here:**
<br>1. transposedData = t(StockReturns) nrow(transposedData) ncol(transposedData)
<br>2. portfolio = apply(StockReturns,c[1,2],mean)
<br>
<br>
...
**Your Answers here:**
<br>DataSet1, Line 9, Change 2001-01-01 to 2000-12-29
<br>
<br>
<br>
